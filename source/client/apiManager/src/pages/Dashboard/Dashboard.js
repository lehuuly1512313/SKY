         ...
         if(this.state.length === 0)
         {
           return(
            ...
            <CopyToClipboard text={this.state.html}>
              <button className="fa fa-clone fa-lg" style = {{ borderRadius:"5px", backgroundColor: "#5c5c6369" ,top : "10px" ,right: "10px", height: "50px", width: "50px", position: "absolute"}}></button>
            </CopyToClipboard>
