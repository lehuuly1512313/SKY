...
class RepMailBox extends Component {
      ...
      <div>
        <div className="site-wrap">
          ...
          <div className="site-section">
            <div className="container">
            <div className ='table-user-title' style = {{marginLeft: '10px'}}><h2>Mail Management</h2></div>
              ...
              <div className="row">
                <div className="col-md-12 form-group">
                  <label htmlFor="message">Message of User</label>
              ...
              <div className="row">
                <div className="col-md-12 form-group ">
                  ...
                  <textarea name id="message" cols={30} rows={10} className="form-control border-red"  />
                </div>
              </div>
              <div className="row">
